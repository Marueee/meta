            ...
            <div class="px-10 py-8">
                <form wire:submit.prevent="save" class="space-y-4 mb-6">
                    <div class="grid grid-col-4 gap-4">
                        ...
                        <div class="text-center text-green-600 p-5">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">RM: {{ $p->price}} </td>
                            <td class="text-center">
                                <div class="p-2">
                                    <flux:button wire:click="edit({{ $p->id }})" variant="primary" icon="pencil-square"></flux:button>
                                    <flux:button wire:click="$dispatch('confirmDelete', {{ $p->id }})" variant="danger" icon="archive-box-x-mark"></flux:button>
                                </div>
                            </td>
                        </tr>
                        @endforeach
